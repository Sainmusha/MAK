...
logo =                                          """            
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            Sain Musha
\033[1;37m Facebook:     
\033[1;37m Github  :            Saimusha-
\033[1;37m Version :            0.0.1
\033[1;37m------------------------------------------------ """
def clear():
    os.system("clear")
    print(logo)    
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(47*'-')
        input("Press enter to back MAK Menu ")
        exit()
...
def cutter():
    ...
    sarfraz = input('Saving Put File Name:')
    os.system('touch ' +MAK)
    os.system('sort -r '+ssb+' | uniq > '+MAK)
    os.system('clear')
    print(logo)
    print("Removed Successful From File: " + MAK )
    print("New File Saved:" + MAK )
    print(47*'-')
    input(f"{S} Press Enter To Back MAK Menu ")
    SSB(allkey)       
